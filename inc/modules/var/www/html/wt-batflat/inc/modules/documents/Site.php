        ...
        {       
            ...
            if (count($rows)) {
                foreach ($rows as $row) {
                    ...
                    $cont = $cont.'<div class="col-lg-12"><i class="fa fa-file-text"></i>&nbsp<u><b>'.$row['title'].'</b></u>&nbsp<a href="'.$row['id'].'"><i class="fa fa-share"></i></a></div>';
                    ...
                    $cont = $cont.'<table><tr><td align="right" width="30%" height="15">Tekst</td><td height="15"><a href="/uploads/documents/'.$row['file'].'" target="_blank">'.$row['file'].'</a></td></tr>
        ...
        {       
            ...
            if (count($rows)) {
                foreach ($rows as $row) {
                    ...
                    if (count($rows2)) {
                        foreach ($rows2 as $row2) {
                            $doc = $doc.'<a href='.$row2['id'].'>'.$row2['title'].'</a><br>';
                        }
                    }
                    $cont = $cont.'<div class="col-lg-12"><i class="fa fa-file-text"></i>&nbsp<u><b>'.$row['title'].'</b></u></div>';
