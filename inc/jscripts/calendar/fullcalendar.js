...
var DayGrid = /** @class */ (function (_super) {
	...
	//const m = new MoonPhase(new Date(date.format('Y'), date.format('M'), date.format('D')));
        //const m = new MoonPhase(new Date(2019,9,14));
	//round = Math.round(m.illum * 100);
	//if (round >= 0 && round <= 10) {moon = '<i class="fas fa-circle"></i>';}
	//if (round >= 11 && round <= 89) {moon = '<i class="fas fa-adjust"></i>';}
	//if (round >= 90 && round <= 100) {moon = '<i class="far fa-circle"></i>';}
	html += '</b></td>';
        return html;
    };
    /* Hit System
